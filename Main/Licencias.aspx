<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Licencias.aspx.vb" Inherits="Main_Licencias" %>
...
<body>
    <form id="form1" runat="server" class="form-horizontal" style="margin-left:20px;">
         ...
         <div class="table-responsive"> 
                    <table id="dgvlicencias" class="table table-hover dgvlicencias" data-paging="true"></table>
                </div>
             ...
             <div class="row opciones_dgvlicencias">              
